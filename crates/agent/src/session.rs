use orchestrator_core::{ContentBlock, MessageContent, TokenUsage, ToolResultContent};
use uuid::Uuid;

use crate::config::AgentConfig;
use crate::message::{GenerateRequest, GenerateResponse, Message, Role};
use crate::tool::{extract_tool_calls, ToolCall, ToolDefinition, ToolOutput};
...
mod tests {
    ...
    use orchestrator_core::StopReason;
